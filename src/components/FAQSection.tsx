...
export function FAQSection({ showBackButton = false, onBack }: FAQSectionProps) {
  ...
  const faqs = [
    {
      ...
      answer:
        'Pick&Bin is an on-demand waste management and recycling service that allows individuals, households, and businesses to schedule pickups for their waste, recyclables, or bulk items in a safe, convenient, and eco-friendly way.',
      featured: true,
    },
    {
      id: 'how-it-works',
      ...
      answer:
        "It's simple: 1) Schedule a pickup via our website, 2) Our verified waste management partners arrive at your location at the scheduled time, 3) Waste is collected, sorted, and disposed of responsibly or sent to recycling facilities.",
      featured: true,
    },
    {
      id: 'pricing',
    ...
    },
    {
      ...
      answer:
        'We accept: Household waste, Recyclables (plastic, glass, paper, cans), Bulk items (furniture, appliances), and Commercial/office waste. Hazardous waste (e.g., chemicals, batteries, medical sharps) requires special handling and may not be accepted.',
      featured: true,
    },
    {
      id: 'be-home',
    ...
    },
    {
      ...
      answer:
        'We accept cash payments, bitcoin and bank transfers. Payments are processed securely before or after service completion, depending on your chosen plan.',
      featured: false,
    },
    {
      id: 'sustainability',
      ...
      answer:
        'Pick&Bin is committed to sustainability. We sort and divert recyclables from landfills wherever possible, supporting a cleaner environment.',
      featured: false,
    },
    {
      id: 'data-security',
      ...
      answer:
        'Yes. We use industry-standard encryption and comply with applicable data protection laws to keep your personal and payment information safe.',
      featured: false,
    },
    {
      id: 'support',
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <p className="text-lg text-gray-600 font-montserrat max-w-2xl mx-auto">
          Find answers to common questions about our waste management services. Can't find what you're looking for? We're
          here to help.
        </p>
      </motion.div>
      ...
      {filteredFAQs.length === 0 && searchTerm && (
        ...
        >
          ...
          <Button onClick={() => setSearchTerm('')} variant="outline" className="font-montserrat">
            Clear Search
          </Button>
        </motion.div>
      )}
      ...
      >
        ...
        <h3 className="text-xl font-semibold text-gray-900 font-montserrat mb-4">Still need help?</h3>
